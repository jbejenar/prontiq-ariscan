 ...
 *   ARI_DELTA_VALUE  — numeric delta value (optional)
...
// Delta info — use ARI_DELTA_VALUE to avoid collision with the CI toggle variable ARI_DELTA
const deltaStr = process.env.ARI_DELTA_VALUE;
const baseScanPath = process.env.ARI_BASE_SCAN;
const hasDelta = deltaStr !== undefined && deltaStr !== "" && !isNaN(parseInt(deltaStr, 10));

...
- **Engine (P2.07):** Pre-commit hooks `--fix` generator — generates `.husky/pre-commit` with lint + typecheck commands using detected package manager. Medium confidence (suggest). Criterion: ARI-SEC-002. 5 new tests.
